...
# The method should return a new array where the elements that return true when given to the block come before all of the elements that 
# return false when given to the block. This means that the new array has two partitions; 
...
def proctition(arr, &blc)
  ...
  return [new_arr1, new_arr2].flatten
end
